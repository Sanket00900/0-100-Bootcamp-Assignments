 ...
 * and t3 seconds respectively. Write a function that uses the 3 functions to
 * wait for all 3 promises to resolve using Promise.all, Return a promise.all
 * which return the time in milliseconds it takes to complete the entire
 * operation.
 */
